...
const mails = [
  ...
  },
  {
    ...
    date: "Oct 23, 2025 02:15 PM",
  },
  {
    name: "Michael Wright",
    email: "m.wright@example.com",
    subject: "Update on your recent inquiry",
    date: "Oct 22, 2025 09:45 AM",
  },
  {
    name: "Emily Lawson",
    email: "emily.lawson@example.com",
    subject: "Weekly Newsletter - Issue #42",
    date: "Oct 20, 2025 04:00 PM",
  },
];
...
export default function SentMails() {
  ...
  // ✅ Refresh logic (you can later fetch from API)
  const handleRefresh = () => {
  ...
  return (
    <div className="flex-1 bg-slate-50 p-8">
      ...
      <div className="border border-blue-400 rounded-lg overflow-hidden">
        ...
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-solid border-blue-300 bg-white">
        ...
        <div className="bg-white">
          <table className="w-full text-sm">
            ...
            <thead>
              <tr className="border-b border-solid border-blue-200">
            ...
            <tbody>
              {mails.map((mail, i) => (
                <tr
                  key={i}
                  className="border-b border-solid border-slate-100 hover:bg-slate-50 transition-colors"
                >
