        ...
        <table className="w-full text-sm">
          ...
          <thead>
            <tr className="border-b border-slate-100">
              <th className="text-left px-6 py-4 text-xs font-semibold text-blue-500 uppercase">
                UserName
              </th>
              <th className="text-left px-6 py-4 text-xs font-semibold text-blue-500 uppercase">
                Phone Number
              ...
              <th className="text-right px-6 py-4 text-xs font-semibold text-blue-700 uppercase">
                Action
              </th>
            </tr>
          </thead>
          ...
          <tbody>
            {contacts.map((c, i) => {
              ...
              const color =
                avatarColors[key] || "bg-slate-100 text-slate-500";
                ...
                >
                  <td className="px-6 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${color}`}
                      >
                        {key}
                      </div>
